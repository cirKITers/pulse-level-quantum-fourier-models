...
for circuit in Circuit_15 Circuit_17 Circuit_19
do
    ...
    do
        ...
        do
            ...
            uv run kedro run --pipeline "fidelity" --params="fcc.seed=$seed,fcc.pulse_params_variance=$variance,model.circuit_type=$circuit" &
